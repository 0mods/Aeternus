package team._0mods.multilib.forge.screen
...
internal class ScreenHooksImpl: ScreenHooks {
    ...
    override fun <T : Renderable> addRenderableOnly(screen: Screen, listener: T): T = screen.addRenderableOnly(listener)

    override fun <T> addWidget(screen: Screen, listener: T): T where T : GuiEventListener, T : NarratableEntry = screen.addWidget(listener)
}