...
interface MagicType {
    @NotNull fun getId(): String

    @NotNull fun numerate(): Int

    @NotNull fun getTranslation(): MutableComponent

    @NotNull fun getClassifier(): MagicClassifier

    @NotNull fun getStyles(): Array<out ChatFormatting>
