...
import team.zeds.aeternus.service.ServiceProvider
...
internal class Materials private constructor(
    ...
    class MaterialProperties(val modId: String, val materialId: String) {
        ...
        var damage = 0F
        var attackSpeed = 0F
        var mainTab: ResourceKey<CreativeModeTab>? = null
        var primaryTabFor: Map<String, ResourceKey<CreativeModeTab>> = mutableMapOf()
    }
