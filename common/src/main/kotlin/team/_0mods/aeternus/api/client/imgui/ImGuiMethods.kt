...
import team._0mods.aeternus.api.client.utils.render
import team._0mods.aeternus.api.util.stream
import team._0mods.aeternus.api.util.texture
import java.util.*
...
object ImGuiMethods {
    ...
    fun image(texture: ResourceLocation, sizeX: Float, sizeY: Float) {
        ImGui.image(texture.texture.id, sizeX, sizeY)
    }
    ...
    fun imageFlip(texture: ResourceLocation, sizeX: Float, sizeY: Float) {
        ImGui.image(texture.texture.id, sizeX, sizeY, 0f, 1f, 1f, 0f)
    }
    ...
    inline fun imageButton(texture: ResourceLocation, sizeX: Float, sizeY: Float, codeBlock: ImGuiMethods.() -> Unit) {
        if (ImGui.imageButton(texture.texture.id, sizeX, sizeY)) codeBlock(ImGuiMethods)
    }
    ...
    inline fun imageFlipButton(
        ...
        if (ImGui.imageButton(texture.texture.id, sizeX, sizeY, 0f, 1f, 1f, 0f)) codeBlock(ImGuiMethods)
