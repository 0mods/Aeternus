...
//    )
    m.identity()
    RenderSystem.setProjectionMatrix(
        Matrix4f().setOrtho(0F, imguiBuffer.width.toFloat(), 0F, -imguiBuffer.height.toFloat(), 1000F, 3000F),
...
fun image(
    ...
    val id = Minecraft.getInstance().textureManager.getTexture(texture).id
